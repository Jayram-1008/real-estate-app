...
const EditCustomer = () => {
    ...
    const handleFormSubmit = (values, onSubmitProps) => {
        ...
        setLoading(true);
        axios.post(apiUrl + 'customer/update', formData)
    ...
    const getCustomer = () => {
        axios.get(apiUrl + 'customer/getone?id=' + id)
            .then(function (response) {
                if (response.data.status) {
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
                                        ...
                                        <Box sx={{ display: "flex", gap: "20px", flexDirection: { xs: "column-reverse", md: "row" }, alignItems: "center" }}>
                                            ...
                                            <Paper sx={{ display: "flex", justifyContent: 'center', flexDirection: "column", alignItems: "center", width: { xs: "100%", md: "180px" }, height: { xs: "250px", md: "220px" }, }}>
                                                <Avatar alt="Profile" src={file.file === null ? apiUrl + "assets/customer-photos/" + id + ".png" : file.image}
                                                    sx={{
